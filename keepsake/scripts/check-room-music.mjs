...
assert.deepEqual(Object.keys(CRT_COLORS),['blue','green','purple','pink','orange','red']);
console.log('Music entry policies, missing playlist fallback, legacy silence and six CRT colors passed.');
