...
export const CRT_COLORS={blue:{background:'#143951',ink:'#b8e6ff'},green:{background:'#183e32',ink:'#c0ffd5'},purple:{background:'#35264f',ink:'#e3caff'},pink:{background:'#64305e',ink:'#ffb8f2'},orange:{background:'#4a3020',ink:'#ffdfb0'},red:{background:'#46252b',ink:'#ffc9cd'}} as const;
