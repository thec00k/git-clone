...
export function BeachfrontScenery({phase,environment,particles}: {phase:Phase;environment:Environment;particles:number}) {
  ...
  return <group>
    ...
    {storm&&<OutdoorWeather kind={environment.weather as 'rain'|'snow'} count={particles} room="beachfront"/>}
  </group>;
}
