...
export function SpotifyDock() {
 ...
 return <section data-music-controls className={`ks-spotify-dock${onCrt?" is-on-crt":""}${visible?" is-expanded":""}`} aria-label="Spotify music player" style={onCrt&&box?{top:box.top,left:box.left,width:box.width,bottom:"auto"}:undefined} data-player-home={onCrt?"crt":"dock"}>
