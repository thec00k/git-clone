...
import {EXTRA_GOODS,NEON_EXTRAS,buyExtra,buyNeonExtra,placePoster,placeNeonSign,getNeonSign} from '../lib/roomShop';
...
export function ShopCreativeExtras(){
 ...
 const items=neon?[...NEON_EXTRAS,...EXTRA_GOODS]:EXTRA_GOODS;
 return <>
