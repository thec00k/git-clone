...
const descriptions={cyberpunk:'A neon skyline, holographic keepsakes and softly glowing lamps.',woodland:'Moss-painted wood, layered forest views and warm lamplight.',beachfront:'An arched window, pale plaster, sea-glass details and a quiet ocean view.'};
